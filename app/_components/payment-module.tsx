...
export default function PaymentModule() {
  ...
  return (
    <>
      <div className='text-center'>{isInsideGuestHours() ? <GuestAccess onClick={() => createSession(false)} loading={isLoading} /> : <BuddySystemAccess onConfirm={() => createSession(true)} />}</div>

      <Script src='https://checkout.reepay.com/checkout.js' strategy='beforeInteractive' />
    </>
  );
}
